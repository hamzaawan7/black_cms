...
export default function Create({ availableEvents }: CreateProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        setData('generate_secret', generateSecret);
        post('/admin/webhooks');
    };
    ...
    return (
        <AdminLayout header="Create Webhook">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        disabled={generateSecret}
                                        className="flex-1 rounded-lg border border-slate-300 px-4 py-2.5 text-slate-900 placeholder:text-slate-400 focus:border-[#c9a962] focus:ring-1 focus:ring-[#c9a962] transition-colors disabled:bg-slate-100"
                                        placeholder="Optional secret key"
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setGenerateSecret(!generateSecret)}
                                    ...
                                    >
                                        ...
                                        {generateSecret ? 'Will Generate' : 'Auto Generate'}
                                    </button>
                                </div>
