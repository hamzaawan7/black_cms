...
export default function Index({ settings = {} }: SettingsIndexProps) {
    ...
    const [data, setData] = useState<SettingsData>({
        ...
        header_background_color: settings.header_background_color || '#f5f2eb',
        header_text_color: settings.header_text_color || '#3d3d3d',
        footer_background_color: settings.footer_background_color || '#f5f2eb',
        footer_text_color: settings.footer_text_color || '#3d3d3d',
